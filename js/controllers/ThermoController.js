...
/*------MODAL AUTOPILOT INTERVAL*/
	...
	$scope.showAutopilotEditInterval = function showAutopilotEditInterval(id)
	{
		...
		$timeout(function(){$scope.modalAutoPilotEdit.modal.show();});
	}
